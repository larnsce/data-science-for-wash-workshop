...
subtitle: "For `r params$iso3` on a `r params$residence` level in `r params$year`"
date: "`r Sys.Date()`"
...
3. Look up the ISO3 country code for a country of your choice 
4. Replace the ISO3 country code at the top of the document under params and next to iso3 with your ISO3 code
...
# smaller subset of data is used
washdata_sml <- washdata %>%
  filter(iso3 == params$iso3) %>% 
